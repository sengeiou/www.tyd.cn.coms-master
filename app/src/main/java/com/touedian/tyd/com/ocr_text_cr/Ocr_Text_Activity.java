 ...
 */
package com.touedian.tyd.com.ocr_text_cr;
...
import com.touedian.tyd.com.utils.FileUtil;
import com.touedian.tyd.com.utilsx.CleanUtils;
...
public class Ocr_Text_Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        findViewById(R.id.idcard_button).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(Ocr_Text_Activity.this, IDCardActivity.class);
        ...
        findViewById(R.id.bankcard_button).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(Ocr_Text_Activity.this, CameraActivity.class);
...
// 调用银行卡识别服务
                            OCR.getInstance().recognizeBankCard(param, new OnResultListener<BankCardResult>() {
                                ...
                                public void onResult(BankCardResult result) {
                                    L.d("222222222222","result="+result.toString());
                                    // 调用成功，返回BankCardResult对象

                                   String number= result.getBankCardNumber();
                                   L.d("number",""+number.toString());
                                }
                                @Override
                                public void onError(OCRError error) {
