 ...
 */
package com.touedian.com.facetyd.wigdet;
...
public class WaveView extends View {
     ...
     *
     * @param waveShiftRatio Should be 0 ~ newhomepageone. Default to be 0.
     ...
     *
     * @param waterLevelRatio Should be 0 ~ newhomepageone. Default to be 0.5.
     ...
     *
     * @param amplitudeRatio Default to be 0.05. Result of amplitudeRatio + waterLevelRatio should be less than newhomepageone.
     ...
     *
     * @param waveLengthRatio Default to be newhomepageone.
