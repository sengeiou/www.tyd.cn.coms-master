...
package com.example.administrator.myapplication.google.zxing.view;
...
//    scannerAlpha = (scannerAlpha + newhomepageone) % SCANNER_ALPHA.length;
//    int middle = frame.height() / newhomepagetwo + frame.top;
//    canvas.drawRect(frame.left + newhomepagetwo, middle - newhomepageone, frame.right - newhomepageone, middle + newhomepagetwo, paint);
    //线性渐变
